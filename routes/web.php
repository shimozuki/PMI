...
Route::prefix('account')->group(function () {
    ...
    //categories debit
    Route::get('/categories_debit/search', 'account\GoldarahController@search')->name('account.categories_debit.search');
    Route::Resource('/categories_debit', 'account\GoldarahController',['as' => 'account']);
    //debit
