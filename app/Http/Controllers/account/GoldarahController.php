...
class GoldarahController extends Controller
{
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(Request $request, Goldarah $categoriesDebit)
    {
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(Request $request, Goldarah $categoriesDebit)
    {
        //set validasi required
        $this->validate($request, [
            'name'  => 'required'
        ...
        //Eloquent simpan data
        $update = Goldarah::whereId($categoriesDebit->id)->update([
            'user_id'       => Auth::user()->id,
            'name'          => $request->input('name')
        ]);
        //cek apakah data berhasil disimpan
    ...
    {
        $delete = Goldarah::find($id)->delete($id);
