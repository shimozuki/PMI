...
class DebitController extends Controller
{
    ...
    public function index()
    {
        $debit = DB::table('debit')
            ->select('debit.id', 'debit.category_id', 'debit.user_id', 'debit.nominal', 'debit.debit_date', 'debit.description', 'golongan_darah.id as id_category', 'golongan_darah.name as category_name')
